...
5. [Safety and Ethics](../../temp_reorg/docs/robotics/safety_ethics.md)
6. [Integration and APIs](../../temp_reorg/docs/robotics/integration.md)
7. [Development and Testing](../../temp_reorg/docs/robotics/development.md)

## Getting Started

To understand and work with the robotic systems:

1. Review the [architecture documentation](architecture.md) for system design
2. Explore specific modules based on your area of interest
3. Check the [development guide](../../temp_reorg/docs/robotics/development.md) for setup and contribution guidelines
